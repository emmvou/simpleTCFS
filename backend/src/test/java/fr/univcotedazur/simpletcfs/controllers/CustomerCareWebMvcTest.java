...
@WebMvcTest(CustomerCareController.class) // start only the specified MVC front controller and no other Spring components nor the server -> Unit test of the controller
